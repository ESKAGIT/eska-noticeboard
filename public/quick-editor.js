(function () {
  ...
  const imageTargets = [
    ...
    [".photo-panel", "image"],
    [".gallery-photo", "image"],
    [".photo-collage-item[data-image-key=\"image\"]", "image"],
    [".photo-collage-item[data-image-key=\"imageLeft\"]", "imageLeft"],
    [".photo-collage-item[data-image-key=\"imageRight\"]", "imageRight"],
    [".photo-collage-item[data-image-key=\"image4\"]", "image4"],
    [".photo-collage-item[data-image-key=\"image5\"]", "image5"],
    [".photo-collage-item[data-image-key=\"image6\"]", "image6"],
    [".photo-carousel-item[data-image-key=\"image\"]", "image"],
    [".photo-carousel-item[data-image-key=\"imageLeft\"]", "imageLeft"],
    [".photo-carousel-item[data-image-key=\"imageRight\"]", "imageRight"],
    [".photo-carousel-item[data-image-key=\"image4\"]", "image4"],
    [".photo-carousel-item[data-image-key=\"image5\"]", "image5"],
    [".photo-carousel-item[data-image-key=\"image6\"]", "image6"],
    [".pt-photo", "image"],
